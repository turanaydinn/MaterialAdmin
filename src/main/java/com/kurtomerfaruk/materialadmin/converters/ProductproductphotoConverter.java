...
import com.kurtomerfaruk.materialadmin.services.ProductproductphotoFacade;
...
public class ProductproductphotoConverter implements Converter {
    ...
    com.kurtomerfaruk.materialadmin.models.ProductproductphotoPK getKey(String value) {
        com.kurtomerfaruk.materialadmin.models.ProductproductphotoPK key;
        String values[] = value.split(SEPARATOR_ESCAPED);
        key = new com.kurtomerfaruk.materialadmin.models.ProductproductphotoPK();
        key.setProductID(Integer.parseInt(values[0]));
        key.setProductPhotoID(Integer.parseInt(values[1]));
        return key;
    }

    String getStringKey(com.kurtomerfaruk.materialadmin.models.ProductproductphotoPK value) {
