...
import com.kurtomerfaruk.materialadmin.services.ProductdocumentFacade;
...
public class ProductdocumentConverter implements Converter {
    ...
    com.kurtomerfaruk.materialadmin.models.ProductdocumentPK getKey(String value) {
        com.kurtomerfaruk.materialadmin.models.ProductdocumentPK key;
        String values[] = value.split(SEPARATOR_ESCAPED);
        key = new com.kurtomerfaruk.materialadmin.models.ProductdocumentPK();
        key.setProductID(Integer.parseInt(values[0]));
        key.setDocumentID(Integer.parseInt(values[1]));
        return key;
    }

    String getStringKey(com.kurtomerfaruk.materialadmin.models.ProductdocumentPK value) {
