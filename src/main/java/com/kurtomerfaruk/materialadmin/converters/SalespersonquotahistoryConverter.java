...
import com.kurtomerfaruk.materialadmin.services.SalespersonquotahistoryFacade;
...
public class SalespersonquotahistoryConverter implements Converter {
    ...
    com.kurtomerfaruk.materialadmin.models.SalespersonquotahistoryPK getKey(String value) {
        com.kurtomerfaruk.materialadmin.models.SalespersonquotahistoryPK key;
        String values[] = value.split(SEPARATOR_ESCAPED);
        key = new com.kurtomerfaruk.materialadmin.models.SalespersonquotahistoryPK();
        key.setSalesPersonID(Integer.parseInt(values[0]));
        key.setQuotaDate(java.sql.Date.valueOf(values[1]));
        return key;
    }

    String getStringKey(com.kurtomerfaruk.materialadmin.models.SalespersonquotahistoryPK value) {
