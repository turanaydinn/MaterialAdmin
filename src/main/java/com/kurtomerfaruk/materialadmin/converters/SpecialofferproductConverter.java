...
import com.kurtomerfaruk.materialadmin.services.SpecialofferproductFacade;
...
public class SpecialofferproductConverter implements Converter {
    ...
    com.kurtomerfaruk.materialadmin.models.SpecialofferproductPK getKey(String value) {
        com.kurtomerfaruk.materialadmin.models.SpecialofferproductPK key;
        String values[] = value.split(SEPARATOR_ESCAPED);
        key = new com.kurtomerfaruk.materialadmin.models.SpecialofferproductPK();
        key.setSpecialOfferID(Integer.parseInt(values[0]));
        key.setProductID(Integer.parseInt(values[1]));
        return key;
    }

    String getStringKey(com.kurtomerfaruk.materialadmin.models.SpecialofferproductPK value) {
