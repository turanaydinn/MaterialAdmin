...
import com.kurtomerfaruk.materialadmin.services.VendoraddressFacade;
...
public class VendoraddressConverter implements Converter {
    ...
    com.kurtomerfaruk.materialadmin.models.VendoraddressPK getKey(String value) {
        com.kurtomerfaruk.materialadmin.models.VendoraddressPK key;
        String values[] = value.split(SEPARATOR_ESCAPED);
        key = new com.kurtomerfaruk.materialadmin.models.VendoraddressPK();
        key.setVendorID(Integer.parseInt(values[0]));
        key.setAddressID(Integer.parseInt(values[1]));
        return key;
    }

    String getStringKey(com.kurtomerfaruk.materialadmin.models.VendoraddressPK value) {
