...
import com.kurtomerfaruk.materialadmin.services.CountryregioncurrencyFacade;
...
public class CountryregioncurrencyConverter implements Converter {
    ...
    com.kurtomerfaruk.materialadmin.models.CountryregioncurrencyPK getKey(String value) {
        com.kurtomerfaruk.materialadmin.models.CountryregioncurrencyPK key;
        String values[] = value.split(SEPARATOR_ESCAPED);
        key = new com.kurtomerfaruk.materialadmin.models.CountryregioncurrencyPK();
        key.setCountryRegionCode(values[0]);
        key.setCurrencyCode(values[1]);
        return key;
    }

    String getStringKey(com.kurtomerfaruk.materialadmin.models.CountryregioncurrencyPK value) {
