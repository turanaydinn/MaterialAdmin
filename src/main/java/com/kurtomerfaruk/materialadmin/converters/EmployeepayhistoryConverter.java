...
import com.kurtomerfaruk.materialadmin.services.EmployeepayhistoryFacade;
...
public class EmployeepayhistoryConverter implements Converter {
    ...
    com.kurtomerfaruk.materialadmin.models.EmployeepayhistoryPK getKey(String value) {
        com.kurtomerfaruk.materialadmin.models.EmployeepayhistoryPK key;
        String values[] = value.split(SEPARATOR_ESCAPED);
        key = new com.kurtomerfaruk.materialadmin.models.EmployeepayhistoryPK();
        key.setEmployeeID(Integer.parseInt(values[0]));
        key.setRateChangeDate(java.sql.Date.valueOf(values[1]));
        return key;
    }

    String getStringKey(com.kurtomerfaruk.materialadmin.models.EmployeepayhistoryPK value) {
