...
import com.kurtomerfaruk.materialadmin.services.ProductinventoryFacade;
...
public class ProductinventoryConverter implements Converter {
    ...
    com.kurtomerfaruk.materialadmin.models.ProductinventoryPK getKey(String value) {
        com.kurtomerfaruk.materialadmin.models.ProductinventoryPK key;
        String values[] = value.split(SEPARATOR_ESCAPED);
        key = new com.kurtomerfaruk.materialadmin.models.ProductinventoryPK();
        key.setProductID(Integer.parseInt(values[0]));
        key.setLocationID(Short.parseShort(values[1]));
        return key;
    }

    String getStringKey(com.kurtomerfaruk.materialadmin.models.ProductinventoryPK value) {
