...
import com.kurtomerfaruk.materialadmin.services.SalesorderheadersalesreasonFacade;
...
public class SalesorderheadersalesreasonConverter implements Converter {
    ...
    com.kurtomerfaruk.materialadmin.models.SalesorderheadersalesreasonPK getKey(String value) {
        com.kurtomerfaruk.materialadmin.models.SalesorderheadersalesreasonPK key;
        String values[] = value.split(SEPARATOR_ESCAPED);
        key = new com.kurtomerfaruk.materialadmin.models.SalesorderheadersalesreasonPK();
        key.setSalesOrderID(Integer.parseInt(values[0]));
        key.setSalesReasonID(Integer.parseInt(values[1]));
        return key;
    }

    String getStringKey(com.kurtomerfaruk.materialadmin.models.SalesorderheadersalesreasonPK value) {
