 ...
 * Created on date 17.01.2017 21:06:48
 */
@Stateless
public class ProductmodelproductdescriptioncultureFacade extends AbstractFacade<Productmodelproductdescriptionculture> {
    ...
    public ProductmodelproductdescriptioncultureFacade() {
