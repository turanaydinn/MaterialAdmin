 ...
 * Created on date 17.01.2017 21:07:05
 */
@Stateless
public class TransactionhistoryarchiveFacade extends AbstractFacade<Transactionhistoryarchive> {
    ...
    public TransactionhistoryarchiveFacade() {
