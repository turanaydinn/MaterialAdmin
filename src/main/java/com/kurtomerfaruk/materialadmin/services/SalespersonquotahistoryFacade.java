 ...
 * Created on date 17.01.2017 21:06:55
 */
@Stateless
public class SalespersonquotahistoryFacade extends AbstractFacade<Salespersonquotahistory> {
    ...
    public SalespersonquotahistoryFacade() {
