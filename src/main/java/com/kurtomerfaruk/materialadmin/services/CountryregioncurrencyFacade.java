 ...
 * Created on date 17.01.2017 21:06:36
 */
@Stateless
public class CountryregioncurrencyFacade extends AbstractFacade<Countryregioncurrency> {
    ...
    public CountryregioncurrencyFacade() {
