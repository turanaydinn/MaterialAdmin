 ...
 * Created on date 17.01.2017 21:06:54
 */
@Stateless
public class SalesorderheadersalesreasonFacade extends AbstractFacade<Salesorderheadersalesreason> {
    ...
    public SalesorderheadersalesreasonFacade() {
