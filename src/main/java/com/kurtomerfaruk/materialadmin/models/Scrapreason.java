...
public class Scrapreason implements Serializable {
    ...
    public Scrapreason(Integer scrapReasonID) {
        this.scrapReasonID = scrapReasonID;
    }

    public Scrapreason(Integer scrapReasonID, String name, Date modifiedDate) {
        this.scrapReasonID = scrapReasonID;
        this.name = name;
    ...
    public String toString() {
        return "com.kurtomerfaruk.materialadmin.models.Scrapreason[ scrapReasonID=" + scrapReasonID + " ]";
    }
