...
public class ProductmodelproductdescriptionculturePK implements Serializable {
    ...
    public String toString() {
        return "com.kurtomerfaruk.materialadmin.models.ProductmodelproductdescriptionculturePK[ productModelID=" + productModelID + ", productDescriptionID=" + productDescriptionID + ", cultureID=" + cultureID + " ]";
    }
