...
public class EmployeedepartmenthistoryPK implements Serializable {
    ...
    public String toString() {
        return "com.kurtomerfaruk.materialadmin.models.EmployeedepartmenthistoryPK[ employeeID=" + employeeID + ", departmentID=" + departmentID + ", shiftID=" + shiftID + ", startDate=" + startDate + " ]";
    }
