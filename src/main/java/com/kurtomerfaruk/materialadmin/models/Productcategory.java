 ...
 * Created on date 17.01.2017 21:04:47
 */
@Entity
...
public class Productcategory implements Serializable {
    ...
    public Productcategory(Integer productCategoryID, String name, byte[] rowguid, Date modifiedDate) {
        this.productCategoryID = productCategoryID;
        this.name = name;
    ...
    public String toString() {
        return "com.kurtomerfaruk.materialadmin.models.Productcategory[ productCategoryID=" + productCategoryID + " ]";
    }
