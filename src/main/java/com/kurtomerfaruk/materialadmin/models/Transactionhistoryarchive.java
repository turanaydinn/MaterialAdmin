...
public class Transactionhistoryarchive implements Serializable {
    ...
    public Transactionhistoryarchive(Integer transactionID, int productID, int referenceOrderID, int referenceOrderLineID, Date transactionDate, String transactionType, int quantity, double actualCost, Date modifiedDate) {
        this.transactionID = transactionID;
    ...
    public String toString() {
        return "com.kurtomerfaruk.materialadmin.models.Transactionhistoryarchive[ transactionID=" + transactionID + " ]";
    }
